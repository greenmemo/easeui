...
public class EaseConversationListFragment extends EaseBaseFragment {
	...
	public void setAvatarShape(int shape) {
		conversationListView.setAvatarShape(shape);
	}
	...
	public void setBorderWidth(int width) {
		conversationListView.setBorderWidth(width);
	}
	...
	public void setBorderColor(int color) {
		conversationListView.setBorderColor(color);
	}
	...
	public void setAvatarRadius(int radius) {
		conversationListView.setAvatarRadius(radius);
	}
}
